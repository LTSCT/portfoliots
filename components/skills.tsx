  ...
  const features = [
    {
      ...
      description:
        "60 % ໃນການເຂົ້າໃຈ, ສຳລັບ HTML,CSS,JS.",
      icon: <IconTerminal2 />,
    },
    {
    ...
    },
    {
      title: "Designer",
      description:
        "70 % ໃນການເຂົ້າໃຈ, ສຳລັບ Canva,PS,AI.",
      icon: <IconBadge3dFilled />,
    },
    {
      title: "Video creator",
      description: "80 % ໃນການເຂົ້າໃຈ, ສຳລັບ AF,PR,AI.",
    ...
    {
      title: "Thai language",
      description: "90 % ໃນການເຂົ້າໃຈ.",
      icon: <IconHexagonLetterTFilled />,
    },
  ];
  return (
